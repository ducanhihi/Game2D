...
public class Sound {
	...
	public Sound() {
		...
		soundURL[8] = getClass().getResource("/sound/sw2.wav");
		...
		soundURL[14] = getClass().getResource("/sound/loadmap1.wav");
		soundURL[15] = getClass().getResource("/sound/coin2.wav");
//		soundURL[16] = getClass().getResource("/sound/game_sound.wav");
